...
namespace URMS.Infrastructure.Migrations
{
    ...
    [Migration("20260807010821_AddExternalStaffOtpFields")]
    partial class AddExternalStaffOtpFields
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("URMS.Domain.Entities.UniversityRequest", b =>
                {
                    ...
                    b.Property<string>("ExternalStaffResponseNotes")
                        .HasColumnType("nvarchar(max)");

                    b.Property<DateTime?>("ExternalStaffSentAt")
                        .HasColumnType("datetime2");
