        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    UniversityCode = table.Column<string>(type: "nvarchar(20)", maxLength: 20, nullable: true),
                    ...
                    AdvisorCode = table.Column<string>(type: "nvarchar(20)", maxLength: 20, nullable: true),
                    AvailabilityDays = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    PendingAvailabilityDays = table.Column<string>(type: "nvarchar(max)", nullable: true),
            ...
            migrationBuilder.CreateTable(
                name: "AvailabilityChangeRequests",
                columns: table => new
                {
                    Id = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    CurrentDays = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    RequestedDays = table.Column<string>(type: "nvarchar(max)", nullable: false),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_AvailabilityChangeRequests", x => x.Id);
                    table.ForeignKey(
                        name: "FK_AvailabilityChangeRequests_AspNetUsers_AdvisorId",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    RequestedHours = table.Column<int>(type: "int", nullable: true),
                    Notes = table.Column<string>(type: "nvarchar(1000)", maxLength: 1000, nullable: true),
                    RejectionReason = table.Column<string>(type: "nvarchar(1000)", maxLength: 1000, nullable: true),
                    AdvisorId = table.Column<string>(type: "nvarchar(450)", nullable: true),
                    AdvisorReviewedAt = table.Column<DateTime>(type: "datetime2", nullable: true),
                    IsGpaConfirmedByAdvisor = table.Column<bool>(type: "bit", nullable: true),
                    StaffId = table.Column<string>(type: "nvarchar(450)", nullable: true),
                    StaffConfirmedAt = table.Column<DateTime>(type: "datetime2", nullable: true),
                    ConfirmationToken = table.Column<string>(type: "nvarchar(256)", maxLength: 256, nullable: true),
                    IsPaymentCompleted = table.Column<bool>(type: "bit", nullable: true),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_UniversityRequests_AspNetUsers_AdvisorId",
                        column: x => x.AdvisorId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id",
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_UniversityRequests_AspNetUsers_StudentId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_AvailabilityChangeRequests_AdvisorId",
                table: "AvailabilityChangeRequests",
                column: "AdvisorId");

            migrationBuilder.CreateIndex(
                name: "IX_UniversityRequests_AdvisorId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_UniversityRequests_StudentId",
                table: "UniversityRequests",
                column: "StudentId");
        }
